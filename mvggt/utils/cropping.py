...
def rescale_image_depthmap(image, depthmap, camera_intrinsics, output_resolution, force=True, normal=None, far_mask=None, instance_map=None):
    ...
    if instance_map is not None:
        instance_map = cv2.resize(instance_map, output_resolution, fx=scale_final,
                              fy=scale_final, interpolation=cv2.INTER_NEAREST)
    ...
    return image.to_pil(), depthmap, camera_intrinsics, normal, far_mask, instance_map

def center_crop_image_depthmap(image, depthmap, camera_intrinsics, crop_scale, normal=None, far_mask=None, instance_map=None):
    """
    ...
    if instance_map is not None:
        instance_map = instance_map[t:b, l:r]
    ...
    return image.to_pil(), depthmap, adjusted_intrinsics, normal, far_mask, instance_map
...
def crop_image_depthmap(image, depthmap, camera_intrinsics, crop_bbox, normal=None, far_mask=None, instance_map=None):
    """
